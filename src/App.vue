<template>
  <div id="app">
    ...
    <template v-for="(list, index) in timeList('aaaaa')">
      <div class="flex flex-aic" :key="index">
        <span class="mr10">
...
export default {
  ...
  data() {
    return {
      aaaaa: '',
      bbbbb: '',
      week: [], // 星期
      date: [] // 天数
    };
